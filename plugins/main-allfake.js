...
handler.all = async function (m) {
  ...
  global.creador = 'Wa.me/529516526675'
  global.ofcbot = `${conn?.user?.jid?.split('@')[0] || ''}`
  global.asistencia = 'Wa.me/529516526675'
  global.namechannel = '𝓓𝓸𝓵𝓹𝓱𝓲𝓷 𝓑𝓸𝓽'
  global.namegrupo = '𝕯𝖔𝖑𝖕𝖍𝖎𝖓-𝕭𝖔𝖙'
  global.namecomu = '𝗖𝗼𝗺𝘂𝗻𝗶𝗱𝗮𝗱 ⏤ 𝓓𝓸𝓵𝓹𝓱𝓲𝓷 𝓑𝓸𝓽'
  global.listo = '⚔️ *Aquí tienes perra*'

  //Ids channel
  global.canalIdM = ["", ""]
  global.canalNombreM = ["⏤ 𝓓𝓸𝓵𝓹𝓱𝓲𝓷 𝓑𝓸𝓽", "㋡ 𝓓𝓸𝓵𝓹𝓱𝓲𝓷 𝓑𝓸𝓽"]
